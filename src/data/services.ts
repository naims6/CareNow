...
export const services = [
  {
    ...
    description: "Certified babysitters and nannies for infants, toddlers, and children. Our caregivers provide safe, engaging, and educational care for your little ones.",
  ...
  },
  {
    ...
    description: "Professional caregivers for senior citizens including companionship, medication management, mobility assistance, and daily living support.",
    ...
    highlights: [
      { icon: Users, text: "Trained in Geriatric Care", color: "text-purple-600" },
  ...
  },
  {
    ...
    description: "Trained caregivers for post-surgery recovery, chronic conditions, special needs, and medical assistance. Professional support for complex care requirements.",
