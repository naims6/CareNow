...
export default function FooterSection() {
    return (
        <footer className="py-16 md:py-20 border-t border-accent">
            <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-4 md:gap-6 text-sm">
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Carenow, All rights reserved</span>
            </div>
        </footer>
    )
}