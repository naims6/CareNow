...
export function CaregiverDetails({
  caregiver,
}: {
  ...
  // additional data for the profile
  const profileData = {
    ...caregiver,
    ...
    services: [
      {
        name: "Hourly Care",
        description: "Flexible hourly care services",
        price: `৳${caregiver.hourlyRate}/hr`,
      },
      {
        name: "Daily Care",
        description: "8-12 hours of daily care",
        price: "৳3,500/day",
      },
      {
        name: "Overnight Care",
        description: "12-hour overnight care",
        price: "৳4,500/night",
      },
      {
        name: "Weekly Package",
        description: "Full week of care services",
        price: "৳20,000/week",
      },
    ],
    reviews: [
      {
        name: "Ahmed H.",
        rating: 5,
        comment: "Excellent care for our elderly mother. Very professional!",
        date: "2 weeks ago",
      },
      {
        name: "Fatima B.",
        rating: 5,
        comment: "Great with children. My kids love her!",
        date: "1 month ago",
      },
      {
        name: "Rahim C.",
        rating: 4,
        comment: "Very reliable and punctual. Highly recommended.",
        date: "2 months ago",
      },
    ],
    availability: [
                      ...
                      {[
                        ...
                        <div key={idx} className="flex gap-4 mb-8 last:mb-0">
                          <div className="flex flex-col items-center">
                            ...
                            {idx < 2 && (
                              <div className="h-full w-0.5 bg-primary/30 mt-1" />
                            )}
                          </div>
                          <div className="flex-1 pb-4">
                            ...
                            <p className="text-muted-foreground mt-3">
                              Provided specialized care services with focus on
                              patient wellbeing and family support.
                            </p>
                          </div>
                        </div>
                      ))}
                  ...
                  <div className="flex items-center justify-between mb-8">
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        {caregiver.rating} rating from {caregiver.reviews}{" "}
                        reviews
                      </p>
                    </div>
